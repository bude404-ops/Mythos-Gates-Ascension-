...
- `src/platform/` owns Platform Core v1 plus the hosted backend boundary adapter: player profile, cloud-save contract, roster ownership, progression, inventory, authoritative ledger, telemetry ingestion, and deterministic import/export continuity.
