# Big Bot Deity Visual Prompt Contract

## Prime directive
Every Deity must look like an actual extradimensional powerful being from its faction and Realm — not a robot, not a mech, not an android, not a human in armor.

## Required prompt ingredients
For each deity, Big Bot must use:

1. Deity canon name and permanent ID.
2. Deity lore and personality.
...
A Deity may carry sacred geometry, pylon influence, stone, metal, roots, halos, horns, masks, and divine ornament — but it must remain a character with readable living anatomy, motion, and presence. Do not generate Deities as walking buildings, blocky towers, cube stacks, fortress torsos, literal temples on legs, city chunks, terrain piles, or abstract geometric sculptures.
...
## Approval gate
Before GitHub import, Big must return the preview with a note explaining why the Deity reads as:
