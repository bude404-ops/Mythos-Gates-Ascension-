...
export const REQUIRED_APPROVAL_TESTS = Object.freeze(['Titan scale', 'Exploration', 'Combat', 'Camera', 'Controls', 'Loading', 'Memory', 'FPS', 'Asset streaming', 'Visual quality', 'Mobile performance', 'Lore consistency']);
...
export function validateMobileFirstArchitecture(contract, framework, firstTemplate) {
  ...
  if (!contract.titanOptimization?.mandate?.includes('not computational waste')) issues.push('Titan optimization mandate must preserve scale without waste');
