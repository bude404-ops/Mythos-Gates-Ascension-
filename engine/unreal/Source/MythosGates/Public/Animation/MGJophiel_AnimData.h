...
#include "MGJophiel_AnimData.generated.h"

// Per-deity animation data asset for Jophiel (MG-DEITY-049)
...
class MYTHOSGATES_API UMGJophiel_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-049"
    static const FName DeityName;      // "Jophiel"
    static const FName WeaponAnimClass; // "BowRanged"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-049_Jophiel"
