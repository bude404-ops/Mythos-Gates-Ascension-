...
#include "MGLucifer_AnimData.generated.h"

// Per-deity animation data asset for Lucifer (MG-DEITY-055)
...
class MYTHOSGATES_API UMGLucifer_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-055"
    static const FName DeityName;      // "Lucifer"
    static const FName WeaponAnimClass; // "StaffCaster"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-055_Lucifer"
