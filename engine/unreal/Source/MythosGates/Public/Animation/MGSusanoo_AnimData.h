...
#include "MGSusanoo_AnimData.generated.h"

// Per-deity animation data asset for Susanoo (MG-DEITY-030)
...
class MYTHOSGATES_API UMGSusanoo_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-030"
    static const FName DeityName;      // "Susanoo"
    static const FName WeaponAnimClass; // "SwordShield"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-030_Susanoo"
