...
#include "MGZeus_AnimData.generated.h"

// Per-deity animation data asset for Zeus (MG-DEITY-019)
...
class MYTHOSGATES_API UMGZeus_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-019"
    static const FName DeityName;      // "Zeus"
    static const FName WeaponAnimClass; // "GreatWeapon"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-019_Zeus"
