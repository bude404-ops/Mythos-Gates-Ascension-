...
#include "MGSutekh_AnimData.generated.h"

// Per-deity animation data asset for Sutekh (MG-DEITY-002)
...
class MYTHOSGATES_API UMGSutekh_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-002"
    static const FName DeityName;      // "Sutekh"
    static const FName WeaponAnimClass; // "StaffCaster"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-002_Sutekh"
