...
#include "MGGabriel_AnimData.generated.h"

// Per-deity animation data asset for Gabriel (MG-DEITY-047)
...
class MYTHOSGATES_API UMGGabriel_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-047"
    static const FName DeityName;      // "Gabriel"
    static const FName WeaponAnimClass; // "StaffCaster"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-047_Gabriel"
