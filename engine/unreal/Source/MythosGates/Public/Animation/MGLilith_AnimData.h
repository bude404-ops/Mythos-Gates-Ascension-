...
#include "MGLilith_AnimData.generated.h"

// Per-deity animation data asset for Lilith (MG-DEITY-057)
...
class MYTHOSGATES_API UMGLilith_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-057"
    static const FName DeityName;      // "Lilith"
    static const FName WeaponAnimClass; // "DualDagger"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-057_Lilith"
