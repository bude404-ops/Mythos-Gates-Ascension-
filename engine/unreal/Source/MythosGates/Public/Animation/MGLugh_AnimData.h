...
#include "MGLugh_AnimData.generated.h"

// Per-deity animation data asset for Lugh (MG-DEITY-040)
...
class MYTHOSGATES_API UMGLugh_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-040"
    static const FName DeityName;      // "Lugh"
    static const FName WeaponAnimClass; // "BowRanged"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-040_Lugh"
