...
#include "MGMorrigan_AnimData.generated.h"

// Per-deity animation data asset for Morrigan (MG-DEITY-039)
...
class MYTHOSGATES_API UMGMorrigan_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()

public:
    UMGMorrigan_AnimData();

    // Deity identity
    static const FName DeityId;        // "MG-DEITY-039"
    static const FName DeityName;      // "Morrigan"
    static const FName WeaponAnimClass; // "SwordShield"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-039_Morrigan"
