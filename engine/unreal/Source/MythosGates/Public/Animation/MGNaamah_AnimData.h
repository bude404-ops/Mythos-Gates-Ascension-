...
#include "MGNaamah_AnimData.generated.h"

// Per-deity animation data asset for Naamah (MG-DEITY-058)
...
class MYTHOSGATES_API UMGNaamah_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-058"
    static const FName DeityName;      // "Naamah"
    static const FName WeaponAnimClass; // "BowRanged"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-058_Naamah"
