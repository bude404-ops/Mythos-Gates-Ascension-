...
#include "MGAmaterasu_AnimData.generated.h"

// Per-deity animation data asset for Amaterasu (MG-DEITY-028)
...
class MYTHOSGATES_API UMGAmaterasu_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()

public:
    UMGAmaterasu_AnimData();

    // Deity identity
    static const FName DeityId;        // "MG-DEITY-028"
    static const FName DeityName;      // "Amaterasu"
    static const FName WeaponAnimClass; // "BowRanged"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-028_Amaterasu"
