...
#include "MGThor_AnimData.generated.h"

// Per-deity animation data asset for Thor (MG-DEITY-011)
...
class MYTHOSGATES_API UMGThor_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-011"
    static const FName DeityName;      // "Thor"
    static const FName WeaponAnimClass; // "GreatWeapon"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-011_Thor"
