...
#include "MGOdin_AnimData.generated.h"

// Per-deity animation data asset for Odin (MG-DEITY-010)
...
class MYTHOSGATES_API UMGOdin_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-010"
    static const FName DeityName;      // "Odin"
    static const FName WeaponAnimClass; // "StaffCaster"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-010_Odin"
