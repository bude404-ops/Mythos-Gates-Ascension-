...
#include "MGRaphael_AnimData.generated.h"

// Per-deity animation data asset for Raphael (MG-DEITY-048)
...
class MYTHOSGATES_API UMGRaphael_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-048"
    static const FName DeityName;      // "Raphael"
    static const FName WeaponAnimClass; // "DualDagger"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-048_Raphael"
