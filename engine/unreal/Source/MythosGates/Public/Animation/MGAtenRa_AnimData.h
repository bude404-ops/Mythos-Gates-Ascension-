...
#include "MGAtenRa_AnimData.generated.h"

// Per-deity animation data asset for Aten-Ra (MG-DEITY-001)
...
class MYTHOSGATES_API UMGAtenRa_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-001"
    static const FName DeityName;      // "Aten-Ra"
    static const FName WeaponAnimClass; // "StaffCaster"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-001_AtenRa"
