...
#include "MGAthena_AnimData.generated.h"

// Per-deity animation data asset for Athena (MG-DEITY-020)
...
class MYTHOSGATES_API UMGAthena_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-020"
    static const FName DeityName;      // "Athena"
    static const FName WeaponAnimClass; // "SwordShield"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-020_Athena"
