...
#include "MGArtemis_AnimData.generated.h"

// Per-deity animation data asset for Artemis (MG-DEITY-021)
...
class MYTHOSGATES_API UMGArtemis_AnimData : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
    ...
    // Deity identity
    static const FName DeityId;        // "MG-DEITY-021"
    static const FName DeityName;      // "Artemis"
    static const FName WeaponAnimClass; // "BowRanged"

    // Skeletal mesh asset path
    static const FName MeshPath;       // "/Game/Meshes/Deities/MG-DEITY-021_Artemis"
