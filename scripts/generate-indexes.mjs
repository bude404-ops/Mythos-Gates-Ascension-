...
const files = {
  ...
  'deity-trial-system.json': 'deityTrialSystem',
  ...
  'deity-role-matrix.json': 'deityRoleMatrix',
  ...
  'deity-enemy-balance-pass.json': 'deityEnemyBalancePass',
  'deity-art-identity-audit.json': 'deityArtIdentityAudit',
