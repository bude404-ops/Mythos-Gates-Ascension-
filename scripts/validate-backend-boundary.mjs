...
const created = backend.createProfile({ playerId: 'MG-BACKEND-VALIDATOR-001', displayName: 'Boundary Validator', starterDeityId: 'MG-DEITY-003' }, { idempotencyKey: 'validator-create' });
