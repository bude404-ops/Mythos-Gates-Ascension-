...
const required=['index.html','game/index.html','game/preview.html','game/shared-preview.js','data/index.json','data/titans.json','data/visual-screens.json','data/realm-codex.json','data/hybrid-visual-architecture.json','data/asset-pipeline.json','docs/lore/README.md'];
