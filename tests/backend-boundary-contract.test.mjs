...
const createdA = backend.createProfile({ playerId: 'TG-BACKEND-PLAYER-001', displayName: 'Cloud Gatebreaker', starterTitanId: 'TG-TITAN-003' }, { idempotencyKey: 'create-player' });
const createdB = backend.createProfile({ playerId: 'TG-BACKEND-PLAYER-001', displayName: 'Cloud Gatebreaker', starterTitanId: 'TG-TITAN-003' }, { idempotencyKey: 'create-player' });
