# The First Reopening — Campaign Lore
...
Mesha Gate-Scribe arrives before the strike force because the Aten Ra record-keepers still listen to abandoned solar pylons. She does not command Titans. She reads the damage and tells the Creator what the Gate is refusing to say.
...
- **Primary threat:** Hollow leakage.
- **Secondary threat:** Gateborn distortion around cracked objective tiles.
- **Mystery pressure:** Forgotten records implying earlier failed reopenings.

The Hollow Mouth should be treated as an absence with appetite, not a cackling monster. It has no need to insult anyone. Its terror comes from calm erasure.

## Lore-Friendly Dialogue Seed

**Mesha:** "Do not mistake silence for safety. A sealed Gate should sleep. This one is listening."

**Mesha:** "If the Hollow takes a name, the wound remains. The world simply forgets who bled."

**Hollow Presence:** "Weight without memory. Shape without oath. Open."

## Tone Guardrails

Avoid jokes, quips, chosen-one language, and heroic banter. The first campaign should sound like professionals entering a sacred disaster.
