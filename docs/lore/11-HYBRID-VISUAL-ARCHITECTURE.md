...
- **2D sprites** are used for player Titans, player characters, enemy characters, enemy Titans, battlefield units, and combatants.
...
- Realm travel is handled through **Titan Gates / Stargates**, not spaceships or sci-fi spacecraft.
...
Titans may be larger than normal characters, but scale must be intentional and consistent.
