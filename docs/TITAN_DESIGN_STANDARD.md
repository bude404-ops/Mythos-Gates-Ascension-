...
The problem: current concepts read as large humans / pin-up goddesses. A titan must read as a MONUMENTAL BEING first, character second.
...
- Eye glow casts light onto cheekbones. Eyes are LAMPS, not features.

### 4. Scale anchors everywhere (3 minimum per image)
- Mortals as SPECKS at the feet (smaller than a titan finger).
- Architecture dwarfed: ankle-high doorways, runestones like pebbles, temple columns at knee height.
- Weather bends: clouds wrap shoulders, storms swirl at ankles, birds fly BELOW the knee.

### 5. Anti-portrait framing
- Low-angle forced perspective ALWAYS. Camera looks UP from mortal height.
- Full body fills frame edge-to-edge with head breaking the skyline.
- NO fashion-portfolio posing. Stances are seismic: planted, braced, unmoved — even assassins coil like a landslide about to happen.
