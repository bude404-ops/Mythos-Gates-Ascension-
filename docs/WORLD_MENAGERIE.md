# THE WAKING WORLD — WORLD FAUNA & CREATURES v1.0
**Canon v1.0 — Sept 5 2026 (BudE404: 'what other creatures can we add... that aren't the hollow but fit the lore').**
The living world AROUND the war. Six classes, each paying off an existing law — and one master principle:

## THE FEED-THE-CONTRAST PRINCIPLE
The Hollow reads by contrast. The warmer, more alive, more COLORED the world is, the more horrifying the de-coloration rings are when they come. Every creature below exists partly so the Hollow has something worth erasing. **The wild world is the horror engine's fuel.**

## GLOBAL LAWS
1. **NON-HOLLOW LAW:** world creatures never show erasure, absence-faces, or color-drain. They are warm, colored, alive. (Fever-sheds are the one exception-family — see VI — and they break a DIFFERENT law, never the Hollow's.)
2. **SUBTLE TELL LAW:** as with mortal dragon-kin, fauna carry their realm's element SUBTLY — a glint, a behavior, a seasonal cycle. Never mini-monsters; the land's small things stay small things.
3. **BEHAVIOR-AS-LORE LAW:** no lore text. Creatures teach by what they DO: where they gather, when they go silent, what they flee. The world's own early-warning and omen systems.
4. **MADE-THING LAW (from the Erasure Line):** wrought creatures cannot be hollowed — craft keeps its purpose forever. This is their horror and their use.
5. **WITNESS LAW:** pure-witness beings cannot be hollowed (nothing to erase — canon, bestiary). The Hollow's Grimlights exist BECAUSE witnesses do. World fauna makes that rivalry visible.
...
- Dungeon role: the non-Hollow miniboss lane — territorial, elemental, ancient. A sworn drake guarding a shrine-hoard: pass the old rite and it lets you in; fight it and the shrine never opens for you again (door-closing, on doctrine).
...
|---|---|---|
| Element-fauna | ambience, traversal, omens | warm |
| Fever-sheds | pressure mobs (mid tier) | sick, sad |
| Drake-kin | sworn minibosses / territorial hoard-guardians | ancient, neutral |
| Wrought wardens | rite-gate bosses, puzzle partners | stubborn, not evil |
| Hollow (bestiary) | the true war | erasure |

**Design outcome:** three threat lanes in every dungeon (fever pressure / territorial ancient / Hollow tide) + two support lanes (witnesses, rite-beasts). Every Depths run can mix and match — the Hollow is only ever ONE of the things hunting you. That's what makes it scarier when it IS the thing.
