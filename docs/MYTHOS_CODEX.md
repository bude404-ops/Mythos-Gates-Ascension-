...
**F1 — ASHFALL** 🔥 (realm: the Cinderlands; glow: molten gold-white)
...
|-------|---------|------|-------------------------------|-------------------|
| Vharkar | the Furnace Warden | Warden | THE ANVILSPLIT MAUL — a great hammer whose head holds a captive sun-core; every strike pours molten judgment | Crucible-Plate: armor cooled mid-pour, frozen drips and flows of living metal |
...
| Vesskra | the Kiln Mother | Caster | THE CRUCIBLE STAFF — a staff crowned with a suspended droplet of molten gold that never falls | Hearth-Band: smooth warm bands, each glowing faint at the seam |
...
|-------|---------|------|--------|-------------------|
| Haeldir | the Thunder Oath | Warden | SKYFALL MAUL — a hammer of compressed storm; the strike lands as thunderclap | Cloud-Forge: slabs of frozen thundercloud, lightning veins at the joints |
...
| Sylwen | the Stormsight | Caster | THE WEATHER-GLASS STAFF — a staff crowned with an orb holding a miniature living storm she reads and unleashes | Vane-Work: rotating fin-plates turning in a wind only she feels |
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Thevril | the Evenhand | Warden | THE LIVING SCALE — a greatblade whose guard holds two floating seeds; one grows, one sleeps | Bloom-Plate: plates like unfurling petals, no seam where stone becomes flower |
| Miriath | the Stillwater | Caster | THE MIRROR STAFF — a staff crowned with a disc of frozen spring water; what it reflects, she can restore or release | Pool-Band: smooth concentric ripple-rings, perfectly calm |
...
Glow: pale violet ghost-light. Materials: bone-pale granite, black-vein marble, dusk-vermilion inlay, tarnished silver. Gate in Mythos: the Dusk Gate, shrine isles.
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Nerovax | the Undertow | Warden | THE TIDAL GREATBLADE — heavier than it looks, like water itself; drags everything near it down | Pressure-Plate: built like compressed depth, denser toward the body's center |
| Ilsarra | the Mirrorfin | Ranged | THE CORAL LONGBOW — grown, not carved; its arrows school like fish mid-flight | Reef-Growth: accreted like a reef, layered colonies of carved coral-stone |
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Grothmar | the Mountain Oath | Warden | THE TECTONIC MAUL — a hammer of the world's first stone; when it lands, the ground remembers | Strata-Plate: horizontal geological bands, each band a different age of stone |
| Bergrun | the Unmoved | Striker | THE CREEPVINE GARROTES — two blade-vines that strangle; she waits, the vines do not | Bulwark-Form: armor like a cliff face, sheer vertical, weathered but never worn |
...
- F1 FIRE (Ashfall): FIRE WYRM — armored draconic plate wings, ember-glow through the seams. (Canon conforms: Vharkar warden pair, Sorvath herald pair, Vesskra hearth-bellows pair, Ozruv ember-fan.)
