...
**THE AVATAR DOCTRINE (Sept 4 2026, BudE404 — LOCKED):** All 24 deities are DRAGON ELEMENTAL GODS — remote, unknowable elemental powers beyond their Gates. The colossi we design are NOT the deities themselves: each is a DRACONIAN AVATAR — the sole unit allowed to cross its Mythos Gate into the mortal realm on the deity's behalf. Retro-explains the First Forge: the shared five-piece Aetherium grammar is the standard construction of a Gate-crossing vessel, a lore fact, not a style choice. Avatar death = that deity's voice in Mythos goes silent until the vessel is re-forged. Seeing avatars in the mortal realm is canon — they are the only divine presence mortals ever witness.

**THE DRAGON SPECIES TABLE (Sept 4 2026, BudE404 — LOCKED, supersedes the element-native wing law):** each faction's avatar is built on its own elemental dragon species — the dragon is the chassis, the element is the identity:
