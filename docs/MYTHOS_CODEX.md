...
**Owner:** BudE404
**Status:** DRAFT — name verdicts pending (BudE404 veto per realm)
**Date:** Sept 4, 2026
...
## WORLD LAW
- 6 factions = 6 main elements: FIRE, AIR, WATER, EARTH, LIFE, DEATH
- Each faction = a REALM DOMAIN the deities were cast to in the exile (faction names ARE realm names)
- Each realm's Gate stands in Mythos — the only bridge between exile and the world they made
- 4 deities per faction = 24 colossi
- Every name invented — no real-culture echoes
- Every deity: Master Titan Formula (COLOSSAL x ELEMENTAL x REALM IDENTITY), one invented armor construction philosophy, one function-made-solid weapon
- Class spread per realm: Warden (warrior), Caster (ALL CASTERS WIELD STAFFS — hard rule), Striker (assassin), Ranged
- The Hollow: a VOID OF ELEMENTAL POWERS — the unformed residue of creation. Not a faction. The wound.

## THE ORIGIN (canon)
1. The six elemental powers helped FORM the mortal realm — Mythos.
2. Creation left a residue: THE HOLLOW, a void of raw unformed elemental power.
3. The Hollow threatened to unmake the young world — so the six TOGETHER imprisoned it. That imprisonment SAVED Mythos.
4. But the act left too much concentrated divine power inside the world — an imbalance Mythos itself could not hold. To keep balance, MYTHOS EXPELLED THE SIX to their realm domains. (This is why the Gates exist, and why the deities cannot simply walk back in.)
5. Ages passed in exile. The six grew into their realms — and FORGOT the Hollow. The imprisonment holding it was built of their combined vigilance, and vigilance faded with memory.
6. The colossi are the six's ONLY way back through the Gates — vessels grown in exile, powered remotely from the realms. Mortal faith is the structural integrity of the whole bridge.
...
Name verdicts RESOLVED (Sept 5 2026): ALL giant names LOCKED via kept Stage 2 art. Sprite champion title-names canon with the sprite art; Stonefell pair renamed per Stage 2 canon (Crystal-Warden + Heartroot-Keeper). Sprite champions wield the elven LOTR armor language (Sprite Armor Law) — ember/storm/bloom/gloom/tide/crystal identity lives in the elven seams; the hollow's Unmade Champions wear the same armor grammar (see HOLLOW_TIDE_BESTIARY v2.0).
...
|-------|---------|------|-------------------------------|-------------------|
| Vaelthorn | the Furnace-King | Warden | THE ANVILSPLIT MAUL — a great hammer whose head holds a captive sun-core; every strike pours molten judgment | Crucible-Plate: armor cooled mid-pour, frozen drips and flows of living metal |
| Sorvath | the Wildfire Herald | Ranged | EMBERWAKE BOW — a bow of charred horn firing arrows that leave burning trails | Char-Shard: cracked char plate revealing the burning body beneath |
...
|-------|---------|------|--------|-------------------|
| Haeldor | the Thunder Oath | Warden | SKYFALL MAUL — a hammer of compressed storm; the strike lands as thunderclap | Cloud-Forge: slabs of frozen thundercloud, lightning veins at the joints |
| Yrdis | the Whisperdrift | Striker | TWIN SQUALL-DAGGERS — blades of hardened wind-glass | Silence-Plate: matte storm-slate scattering light, edges dissolving into vapor |
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Thevraine | the Evenhand | Warden | THE LIVING SCALE — a greatblade whose guard holds two floating seeds; one grows, one sleeps | Bloom-Plate: plates like unfurling petals, no seam where stone becomes flower |
| Mirielle | the Stillwater | Caster | THE MIRROR STAFF — a staff crowned with a disc of frozen spring water; what it reflects, she can restore or release | Pool-Band: smooth concentric ripple-rings, perfectly calm |
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Nerovane | the Undertow | Warden | THE TIDAL GREATBLADE — heavier than it looks, like water itself; drags everything near it down | Pressure-Plate: built like compressed depth, denser toward the body's center |
| Ylsanne | the Mirrorfin | Ranged | THE CORAL LONGBOW — grown, not carved; its arrows school like fish mid-flight | Reef-Growth: accreted like a reef, layered colonies of carved coral-stone |
...
| Deity | Epithet | Role | Weapon | Armor Philosophy |
|-------|---------|------|--------|-------------------|
| Grathwyn | the Mountain Oath | Warden | THE TECTONIC MAUL — a hammer of the world's first stone; when it lands, the ground remembers | Strata-Plate: horizontal geological bands, each band a different age of stone |
| Bergrune | the Unmoved | Striker | THE CREEPVINE GARROTES — two blade-vines that strangle; she waits, the vines do not | Bulwark-Form: armor like a cliff face, sheer vertical, weathered but never worn |
| Rhovarr | the Quakecaller | Caster | THE FAULTLINE STAFF — a staff split by a living crack; the crack widens on command | Fault-Work: glowing hairline fractures, the power inside held back by will |
| Dolvarr | the Deeproot | Ranged | THE SEEDSTRIKE BOW — living branchwood; its arrows root where they land | Ring-Growth: tree-ring spirals, each ring a century of patience |
...
- ARCHER = BOW
Identity comes from FACTION (material, elemental philosophy, named relic lore) on top of the fixed chassis — never from a different weapon type. Registry reconciliation: Vaelthorn's Crucible Maul converts to the CRUCIBLE BLADE (two-handed gouged greatsword, demon-fang lattice guard, molten core channeled down the fuller). Vessamaine's Crucible Staff conforms. Sorvath's Emberwake Bow conforms. Ozruv's Scale-Chain conforms as dual swords with the chain as ornament variant. Haeldor's Skyfall Maul converts to the SKYFALL BLADE (storm greatsword, frozen thundercloud core) on his keep. Any kept avatar whose canon art shows an off-chassis weapon gets a weapon-swap direct edit — chassis is law across the board.

**THE HUMAN ASPECT ARMOR TRANSFORMATION LAW [SUPERSEDED — sprite vessels redesigned under Giants & Sprites doctrine] (Sept 4 2026, BudE404 — LOCKED):** When a deity shapes its human-sized aspect, the First Forge Aetherium armor TRANSFORMS WITH THE VESSEL — because it can. The human aspect does NOT wear the colossal set at full warden-scale exaggeration; the divine metal re-forges itself into HUMANLIKE construction: fitted to the human frame, human-scale pauldrons and plates, articulated like true mortal master-smithing — while keeping the same soul: the same primordial gouged Aetherium material and finish, the same faction philosophy, the same named relic weapon at mortal scale, the same sigil as the only glyph, and ember-glow eyes as the only divine tell. The divine reads in the PERFECTION and material — impossible craft — not in impossible mass. Supersedes the 'armor too massive for any mortal knight' clause of the first human-aspect rolls.
**THE WING-CAPE CONVERSION [SUPERSEDED — sprite-scale vessels redesigned under the Giants & Sprites Doctrine] (Sept 4 2026, BudE404 — LOCKED):** On the human-sized aspect, the draconic wings DO NOT stay folded on the back — the Aetherium re-forges them into a CAPE. The wing architecture survives in the cape's construction: gouged plate-vanes and scale-work of the same primordial Aetherium as the chest plate, hanging from the back-plate/pauldron anchors, ember-glow seams, clawed tips reading as the cape's lower corners. The colossal avatar keeps full draconic wings; the human aspect wears them as a cape. **HUMAN BOOTS CLAUSE (Sept 4 2026, BudE404: 'boots need be more human'):** The transformation law extends to the FEET — human aspects wear fitted HUMAN boots, not clawed beast-sabatons: sleek knee-high greaves ending in normal human-boot silhouettes with squared armored toes, mortal master-smithing proportions. Clawed sabatons are colossal-avatar-only. **DRACONIC BOOTS REFINEMENT (Sept 4 2026, BudE404: 'boots still need the draconic effect just needed to resemble human boots'):** Human boots keep the human silhouette but carry DRACONIC CHARACTER: overlapping dragon-scale plate-work down the shins, small curved claw-tip accents on the squared toes, tiny fang ridges along the front, horn spurs at the heels, ember-glow in the scale seams. Human boots wearing the dragon — draconic effect, human shape. Plain featureless boots are as wrong as full beast-sabatons. CAPE verdict: KEPT ('I like capes now').
...
**HUMAN ASPECT BACKGROUND POLICY [SUPERSEDED] (answering BudE404's question, Sept 4 2026):** Human aspects roll as STAGE-1 CHARACTER LOCKS on a neutral dais (clean for verdict review + future 3D reference — the same reason the original Stage-1/2 pipeline exists); colossal avatars REQUIRE full realm compositions because scale anchors are law for the colossal read (min 3 anchors, low-angle framing). On request, any canonized human aspect gets a STAGE-2 WORLD COMPOSITION pass — the same character placed into its faction's mortal Mythos setting with the Divine Influence grammar.
...
**ART STYLE LAW [SUPERSEDED — LOTR-cinematic filmic now canon, 'lets go with the lotr style'] (Sept 4 2026, BudE404 ruled Option A):** The SURFACE style is HAND-PAINTED STYLIZED fantasy (WoW / Guild Wars 2 family) — bold brushwork textures, stylized anatomy, rich saturated color, painterly edges. The COMPOSITION law is unchanged: LOTR-cinematic framing x Warcraft world-scale (camera, lighting, atmosphere, monumentalism). Cinematic mood comes from lighting + composition, never from realistic detail. Standard prompt grammar line for every roll: 'hand-painted stylized fantasy, bold brushwork, saturated palette, Warcraft-scale silhouette, cinematic lighting.' Chosen for pipeline-wide ease: strongest generation consistency (painterly hides artifacts, drifts least), best gen-to-3D conversion (clean readable silhouettes), cheap hand-painted textures vs PBR realism, mobile-first performance. Realism-family styles (Witcher) are excluded — drift-heavy and cost-multiplied across 24 deities + environments.

**HUMAN ASPECT LAW AMENDMENT [SUPERSEDED] (Sept 4 2026, BudE404):** ALL human aspects wear FULL HELMETS — NO faces anywhere, the ember-glow eyes shine from inside the helm's shadow/visor slit. AND armor is EXAGGERATED in size — Warcraft Grammar applies to humans too: oversized pauldrons, massive chest plates, bulky gauntlets/greaves; heroic impossible proportions while staying a human silhouette. Human aspects read as living siege-figures of their region's armor style.

**DRAGON-HUMAN ARMOR PARITY LAW [SUPERSEDED] (Sept 4 2026, BudE404):** A deity's HUMAN armor is a MINIATURE of their DRAGON's grown barding — same primitive gouged relic material, same signature grammar, same faction sigil. NOT refined mortal craft: the armor reads PRIMORDIAL — gouged, ancient, grown-looking, as if it emerged from the same forge that shaped the dragon's scales. Vaelthorn's human = his dragon's gouged plate grammar + crucible-core heart; Vessamaine's human = hearth-bands. AND human forms carry DRACONIC EFFECTS — ember-dissolve at edges, molten heat-crack seams, draconic helmet motifs echoing the dragon's skull-crown, ember-glow tells. Supersedes the mortal regional-craft-only reading of the human armor law: humans wear the same relic language as their gods' dragon forms, one forge, one family.
...
- Each faction's deity pair maps cleanly to the two roles: the greatsword chassis (warrior) and the long staff chassis (caster). Gender does NOT bind role — the pair just covers both weapons (current pattern: Haeldor blade / Sylwenna staff, Thevraine blade / Mirielle staff pending verdicts).
...
- All dragon-form deity canon retires (Vaelthorn, Vessamaine, Haeldor, Sylwenna, Thevraine drakes). The hooded vessel canons retire with them (dragon-scale skin law is dragon-specific).
...
## COLOSSAL RAW-ELEMENTAL LAW (Sept 4 2026, BudE404 — LOCKED, settles Open Ruling 1)
**The colossal giant true forms are RAW ELEMENTAL — pure living element, zero armor.** No relic armor pieces, no plates, no Aetherium anchors: the compressed muscle-mass elemental body IS the whole colossal (fire-muscle, storm-mass, petal-flesh, stone-mass, wave-mass, shadow-mass — the First Forge elemental-body grammar at full purity). Anatomy reads as sculpted elemental muscle — dense, churning, alive — with the element's own texture vocabulary (molten seams, crackling static, drifting petals, sediment strata). The Gender-Role weapons still manifest: the colossal warrior's greatsword and caster's staff are FORGED OF THE GIANT'S OWN ELEMENT — condensed flame, frozen storm, petal-glass — wielded bare-handed by a body of raw element. Sprite-scale vessels keep their crafted gear; the colossal side goes raw.

## PLAYER-SCALE RULING (Sept 4 2026, BudE404 — LOCKED, settles Open Ruling 2)
**Players control BOTH scales: the GIANTS exactly as they would have controlled the dragons (the colossal playable avatar — Tower Waves, kaiju-events, god-mode), and the SPRITES exactly as they would have played the humans (the mortal-scale playable side — cities, quests, combat at sprite scale).** Dual-scale play confirmed: giant mode = raw-elemental colossal with element-forged greatsword/staff; sprite mode = the mortal civilization gameplay. The deity vessel doctrine simplifies: the playable giant IS the colossal form; the sprite-scale vessel role is covered by sprite-mode play.

## SPRITE AESTHETIC LOCKED (Sept 4 2026, BudE404: 'sprites equal serious fey in looks' — settles Open Ruling 3)
**The sprites are SERIOUS FEY — dignified fey-small beings standing 1-3 feet tall (BudE404 ruling 'B': a real civilization at their own scale vs the 100-ft giants), never cute Pixar mascots.** Fey gravity: lithe elongated proportions, sharp noble features, faction-palette armor and robes at their scale, element-touched glowing eyes, fine wings or elemental veils only where the faction's element warrants. They are a civilization of small ancient peoples — warriors, casters, scholars — who happen to stand 1-3 feet tall, not whimsical decorations. Enemy sprites fight like disciplined soldiers; worshipful sprites kneel like a congregation. ALL THREE OPEN RULINGS NOW SETTLED: raw-elemental colossi, dual-scale play, serious-fey sprites.
...
- FIRST CANON: ASHFALL-FIRE-GIANT-CANON.jpg — name VAELTHORN (the Furnace-King, re-forged as primordial fire giant). Vaelthorn wields the condensed-magma GREATSWORD (Gender-Role Binding: male = warrior).
