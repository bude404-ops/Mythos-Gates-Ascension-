...
- **Realms**: [romantic element word] + [Avalon place-suffix] — mere (lake), march (borderland), weald (wildwood), barrow (burial-mound country), vale, fell (high crag country).
- **Gods**: personal names + regnal form — every god is a SLEEPING MONARCH: "the Sleeping King/Queen of [realm]" + functional epithet. (This also fixes the WARDEN title collision: gods no longer share the player-role word "Warden" — they are Kings and Queens.)
- **Gates**: single romantic element word + "Gate."
- **Roads**: "Warden of the Ember roads" — address grammar per realm.
- **Mortal regions**: the [element]-Marches.
- First letters kept where possible so canon art still maps at a glance.

## THE RECAST TABLE

| Faction | Old realm | NEW REALM | Old gods | NEW GODS (Sleeping Monarchs) | Old Gate | NEW GATE |
|---|---|---|---|---|---|---|
| Fire | Ashfall / Cinderlands | **EMBERMERE** — caldera country, the molten mere | Vharkar (Furnace Warden) / Vesskra (Kiln Mother) | **VAELTHORN, the Sleeping King — the Furnace-King** / **VESSAMAINE, the Sleeping Queen — the Kiln-Queen** | Cinder Gate | **EMBER GATE** |
| Air | Skyrend / Stormshards | **GALEMARCH** — the storm ridges | Haeldir / Sylwen | **HAELDOR, the Storm-King** / **SYLWENNA, the Gale-Queen** | Squall Gate | **GALE GATE** |
| Life | Everbloom | **BLOOMWEALD** — the flowering wildwood | Thevril / Miriath | **THEVRAINE, the Bloom-King** / **MIRIELLE, the Root-Queen** | Bloom Gate | **BLOOM GATE** |
| Death | Duskmourn | **GLOAMBARROW** — the grey moors and barrow-downs | Morvain / Senvra | **MORVAINE, the Dusk-King** / **SENNETH, the Barrow-Queen** | Dusk Gate | **BARROW GATE** |
| Water | Marenth | **MARENVALE** — the seafloor shelf and tide-country | Nerovax / Ilsarra | **NEROVANE, the Tide-King** / **YLSANNE, the Deep-Queen** | Deep Gate | **DEEP GATE** |
| Earth | Stoneheart | **STONEFELL** — the world's deep spine | Grothmar / Bergrun | **GRATHWYN, the Stone-King** / **BERGRUNE, the Rune-Queen** | Stone Gate | **RUNE GATE** |

## CONSEQUENCES

- **Mortal regions** become the Marches: Embermarch, Galeways, Bloommarch, Barrowmoor, Tidemarch, Stonefell-march (gate-towns keep their own names per NPC roster — re-keyed in the sweep).
- **Roads grammar**: Ember roads / Gale roads / Bloom roads / Barrow roads / Deep roads / Rune roads.
- **Player address**: "Pilgrim of the Ember roads" etc.
