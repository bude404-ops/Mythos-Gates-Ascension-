...
- MYTHOS expelled the six to keep balance; the combined vigilance of the six imprisoned the residue. Ages of exile dulled that vigilance.
- THE FORGOTTEN — the deity left trapped on the void side when the Gates were raised — directs the residue now. Its resentment is the Hollow's tide-pull; its shards force the fractures through broken Gates.
- THE HOLLOW CANNOT CREATE. Every unit is an ERASED COPY of something real — the erasure is the art direction. NEVER goo/rot/gore horror: ERASURE horror. The scariest thing about them is what's missing.
...
## THE ERASURE LINE, part 2 — MADE vs NAMED (Sept 5 — BudE404: 'why do villagers erase while holding finished things?')

Two different properties, previously conflated. Split them:

- **MADE things resist erasure of THEMSELVES, but protect no one.** A villager's cloak is finished, so the Hollow can't eat the cloak — but the cloak confers nothing on its wearer. Made-ness is passive: it just stands its ground. The Mutefolk wear their clothes because the clothes stand; the person inside is alive — alive means unfinished — and the Hollow takes what's unfinished. Holding a hammer never saved anyone.
