...
Official cosmology: six tensions. But: the Concorde's oldest road-surface shows SEVEN styles of footprint from the Walking Age. The Gate-finch does not sleep — and no one asks why a bird would evolve that unless it needed to watch something continuously. And the contract at the Rune Gate has a seventh signature. Buried truth: Aetherium has a seventh tension — the first one — the tension that held the others in balance before the Forge: SILENCE. It never became a god; it became the PAUSE between the others — and the pause is where the void was later cut. (Deliberately unanswered for DLC: did Silence consent?)
