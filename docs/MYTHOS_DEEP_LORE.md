# MYTHOS — THE DEEP LORE
**Canon v1.0 — Sept 4 2026. The BURIED LAYER beneath the world bible. The surface story (WORLD_BIBLE) is what mortals believe; THIS document is what's actually true — hidden in item descriptions, environmental contradictions, and NPC slips. Design rule: the truth is never told; it is ASSEMBLED. Nothing here appears in any quest text verbatim.**

## I. THE FIRST LAW OF DEEP LORE: THE CANON LIES (a little)

In-game, there is no omniscient narrator. What mortals know is:
1. The Concord Record (official, political, written by the victors of the Gate Age)
2. Six regional traditions (each credits ITS god first, each contradicts the others on the Balancing)
3. The Hollow knows the truth and cannot speak it (it hollowed its own memory erasing things)
**Design rule:** every codex entry, every NPC, every item description has a SOURCE — and sources have interests. The player triangulates.

## II. THE SEVEN MYSTERIES (the campaign's buried spine — each has a planted, discoverable answer and a deliberate remainder)

### MYSTERY 1 — WHO FORGED THE GATES?
Official canon: "Mythos itself raised the Gates." But: the tooling marks on the Gate masonry are FIRST FORGE work — the gods built them. The buried truth: the Balancing was not the world rebelling; it was a CONTRACT the gods signed, and the Gates are its terms — built to be opened. Which raises the question nobody asks: who wrote the contract? (Answer planted in the Stone Gate's deepest vault: a seventh signature, smudged, unreadable. See Mystery 7.)
...
### MYSTERY 5 — THE SEVENTH TENSION
Official cosmology: six tensions. But: the Concorde's oldest road-surface shows SEVEN styles of footprint from the Walking Age. The Gate-finch does not sleep — and no one asks why a bird would evolve that unless it needed to watch something continuously. And the contract at the Stone Gate has a seventh signature. Buried truth: Aetherium has a seventh tension — the first one — the tension that held the others in balance before the Forge: SILENCE. It never became a god; it became the PAUSE between the others — and the pause is where the void was later cut. (Deliberately unanswered for DLC: did Silence consent?)

### MYSTERY 6 — WHY THE GATES OPEN
If the Gates are the Balancing's terms, they should be sealed. They open (Bloom Gate yearly, Deep Gate to divers, all Gates to the giants at the Fracture). Buried truth: the contract's terms are not imprisonment — they are DINNER BELLS. The Gates are faith-pumps: belief flows one way, power the other, forever. The gods signed a contract that feeds them and keeps them OUT. It was, on its face, a good deal — for the gods. The Fracture proved what the contract really was: a pressure valve. Something was always meant to eventually push through. The Hollow didn't break the system. The system is working exactly as designed, and the seventh signature designed it. (Fan-theory fuel: WHO benefits from the Hollow Tide? Not the gods, not Mythos... the one being who cannot enter either way — because when everyone else is hollowed, there will be no belief to keep ANY Gate shut against it.)

### MYSTERY 7 — THE SONG'S OTHER VERSE
Every faction's festival song shares the melody (the Forgotten's name). Buried detail only archivists notice: every regional version has the SAME extra verse about "the home that waits where no road goes." It is in no regional language's grammar — the verse predates the languages. It was not a verse ABOUT something. It was a LULLABY'S ENDING. The Forgotten used to sing someone to sleep.
...
- **The Forgefall first-ember shard (key item):** "Vesskra's gift. It burns without fuel. Every hearth in Forgefall is its descendant. The mothers of the Emberwaste tell children it will go out if ever no one is kind."
...
- **Contract fragment (Stone Gate vault):** "Six signatures in god-claw. One smudge. The stone remembers the seventh hand was COLD."
...
## V. WHAT IS DELIBERATELY NEVER ANSWERED (theory-crafting fuel, post-campaign)
