...
## I. THE PREMISE (elevator pitch)

The gods made the world — and the world threw them out.

Mythos is the mortal realm, the battlefield of everything. Long ago the six elemental powers helped form it, and their act of creation left a wound: THE HOLLOW, a void of raw unformed power. The six imprisoned it together — and Mythos itself, unable to hold that much concentrated divinity, EXPELLED the six into their realm domains. The Gates are the only bridges back, and mortal BELIEF is the mortar that holds them open.

Ages passed. The six grew into their realms — and forgot the Hollow. Its prison, built of fading vigilance, now cracks. Fractures spread across Mythos, and through them the Hollow spawns.
...
## V. CAMPAIGN STRUCTURE — HOW THE SCALES INTERLEAVE
...
## VIII. THE HOLLOW — ENEMY DESIGN LANGUAGE
...
7. F2–F6 KEPT PAIRS LOCKED (1M+1F each): AIR Haeldor + Sylwenna. LIFE Thevraine + Mirielle. DEATH Morvaine + Senneth. WATER Nerovane + Ylsanne. EARTH Grathwyn + Bergrune. (All names confirmed Sept 5 2026; the other twelve deities = deferred identities per the Two-Role Lock.)
