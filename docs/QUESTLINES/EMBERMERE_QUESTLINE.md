# EMBERMERE — THE COLD MERE (Ashfall chapter questline · QUEST DOCTRINE PILOT)

**Canon:** Sept 5 2026 · Written to THE AVALON QUEST DOCTRINE v1.0 (HOOK/TRAIL/RITE/CHOICE/ECHO; one truth-sliver per quest; want/lie/cost NPCs; two-goods choices; saga-sites not lore cards)
**Theology in play (shown, never told):** heat is duty — the forge must burn something, and the question is always *what*.
**Chapter wound:** the Ember Gate flickers; a silence-siege is eating worship before it reaches the god. FAITH that should fill the Gate is being dammed in the charcoal forest.

---

## MAIN QUESTLINE (6 quests + the Gate Rite finale)

### Q1 — "THE FIRST POUR" (Forgefall, arrival)
- **HOOK:** The gate-capital's crucible-core hearth towers won't light for the season's First Pour. The hearth-warden asks the pilgrim to carry the seed-flame from the Cinder Gate itself. *(Want: the pour must happen. Lie: she already knows the Gate's flame is failing — she sent a stranger because she can't watch it be her. Cost: if the Gate fails the pilgrim publicly, the warden's order takes the blame.)*
- **TRAIL:** Down through the forge-cathedrals past the tribute-reef walls — centuries of offerings fused into the strata (the world SHOWS the god's age). The seed-flame dims near certain streets (first hint of the silence-siege).
- **RITE:** The First Pour — the pilgrim pours the seed-flame into the crucible with the wardens' iron ladle, speaking the pour-oath the crowd murmurs half of (rite half-performed: muscle memory first).
- **CHOICE (two goods):** The seed is only enough for ONE tower — the keepers' tower (the city's winter warmth) or the forges (the guilds' livelihood and their harvest-debt payments). **Door closes for the season, visibly.**
...
- The doctrine's worked example, promoted to canon questline slot (QUEST_DESIGN_DOCTRINE.md): the kiln-master who won't light her kiln; the oathsmiths' cellar of undelivered first-pours; the kiln-oath spoken aloud; honor-vs-mercy on the harvest-debt.
...
- **CHOICE (two goods):** Pay the tide-debt — the fisher fleet grounds a season, the harbor's blessing stands — or refuse — the fleet sails fat, and the tide's interest rides on Marenvale's ledger against the player. **The Marenth ledger-keeper's word travels ahead of the pilgrim to Marenvale (cross-region door, BG3).**
- **ECHO:** The fleet rides at anchor or at sea; the ledger-keeper greets the pilgrim warmly or coldly in every later Marenvale town.
- **TRUTH-SLIVER:** The gods keep each other's ledgers. (Pantheon depth, learned from a tax bill.)
...
- **THE WAKING:** The Echo shatters; the ash falls upward; **the Gate Rite completes and VAELTHORN WAKES THROUGH THE PILGRIM** — the colossal passage (siege-mode moment), the Hollow burns off the Embermere, the realm cleanses.
...
## DEPTHS + ENDGAME TIE-IN
The **Ashfall Depths** (procedural fracture dungeons) = **the Furnace King's fever of the forge** — layouts of half-poured castings, tribute-flood vaults, kilns burning in dreams. Every depth-run yields one witnessable fragment (a Tidal Greatblade cast in forge-slag — Nerovane's debt to Vaelthorn, seen not read). The Gate Cycle endgame ticks behind the chapter: an unfed Cinder Gate slides the Embermere toward Hollow (Diablo pillar, questline is the feeder).

## DOCTRINE AUDIT (pilot gate — BudE404: "if it's successful run them all")
- [x] Master law: every truth-sliver delivered by DOING / SHOWING / ASKING — zero lore text required
- [x] One sliver per quest, six slivers, no overlap
- [x] Want/lie/cost on every quest-giver
- [x] Two-goods in every CHOICE (no right answers)
- [x] Door-closing tracked: Q1 tower, Q4 cross-region, Q5 finale-strength, Q6 roll call
