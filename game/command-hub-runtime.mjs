...
export function createCommandHubRuntime(DATA, mount){
  ...
  const FALLBACK_CREATURES = [
    ...
    { id:'TG-CREATURE-019', name:'Aten Ra Sun-Seal Vigilant', combatRole:'CONTROLLER', abilities:['Aten Ray Lattice','Ma\u2019at Measure Bind','Solar Lane Verdict'], mapBehavior:'Locks lanes and punishes Titans who ignore objective geometry.', aiProfile:{ archetype:'CONTROLLER' }, stats:{ hp:126, damage:22, range:3, armor:7, resistance:8, movement:4, threatWeight:3 } },
    ...
    { id:'TG-CREATURE-034', name:'Empyrean Radiant Censor', combatRole:'CONTROLLER', abilities:['Censure Beam','Halo Sight','Contradiction Brand'], mapBehavior:'Marks the Titan and supports disciplined ranged fire.', aiProfile:{ archetype:'CONTROLLER' }, stats:{ hp:88, damage:16, range:3, armor:5, resistance:5, movement:4, threatWeight:2 } },
  ...
  const AWAKENING_BEATS = [
    ...
    { step:10, id:'TITAN_TRIAL_HANDOFF', lesson:'Titan Trial', missionBeat:'Temporarily pilot a second Titan with its mechanic, sample gear, and Divine Ascension.', playableSystem:'temporary trial', milestone:'AWAKENING_BEAT_10' },
