...
DEITY_COMBAT_KITS = {
    ...
    "Khemet": {
        "basicAttack": "Dawn Strike — Khemet pushes forward with scarab-carapace blows. Each hit stores a small amount of dawn energy in his amber core. Third hit releases a stored burst of solar renewal that damages nearby enemies and slightly heals Khemet.",
        ...
        "signature": {"name": "Dawn Reforged", "type": "Burst", "cd": 20, "divineCost": 75, "effect": "Unleash all stored dawn energy in a massive amber explosion. The more energy stored, the larger the blast. Heals Khemet for 15% of damage dealt."},
        ...
        "passive": {"name": "Renewal Engine", "effect": "Khemet stores dawn energy from every basic attack and damage taken. At 10 stacks, his next basic attack releases a free Renewal burst."},
    },
    "Nefra": {
        "basicAttack": "Threshold Pulse — Nefra fires obsidian mirror shards from her hands. Each shard pierces one enemy and leaves a small void mark. Third hit detonates all void marks on screen for bonus damage.",
        ...
        "ability2": {"name": "Dusk Veil", "type": "Crowd Control", "cd": 9, "divineCost": 35, "effect": "Create a zone of controlled darkness around her. Enemies inside are blinded and their attacks have 50% miss chance. Nefra gains invisibility within the zone."},
        ...
        "ultimate": {"name": "Obsidian Dawn", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Nefra becomes the threshold itself for 8 seconds: she transforms into living obsidian, immune to all damage. Her body absorbs all enemy projectiles and spells, then fires them back as void-charged blasts. All enemies near her are slowed by 50%."},
        "passive": {"name": "Threshold Keeper", "effect": "Nefra gains a void stack every time an enemy enters or exits her zones. At 5 stacks, her next ability creates an additional void zone."},
    },
    "Orru": {
        "basicAttack": "Verdict Combo — Orru strikes with amber glass blades in a fast 4-hit combo. Each hit refracts light, creating a spectrum line that damages enemies in a line behind the primary target. The fourth hit shatters the blades, dealing AoE damage.",
        ...
        "ability2": {"name": "Truth Reveal", "type": "Execute", "cd": 10, "divineCost": 40, "effect": "All enemies within range are weighed by the prism — those below 30% HP are marked for execution. Marked enemies take 3x damage from Orru's next attack and are visible through walls."},
        ...
        "ultimate": {"name": "Divine Verdict", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Orru becomes the Living Scale for 10 seconds: every enemy on screen is constantly weighed. Their true weight (HP, buffs, debuffs) is visible. All of Orru's attacks become piercing prism beams that deal bonus damage equal to the enemy's missing HP percentage."},
        "passive": {"name": "Truth-Prism", "effect": "Every debuff Orru applies adds a prism stack. At 5 stacks, his next basic attack becomes a piercing prism beam that passes through all enemies in a line."},
    },
    
    # === ASGARDIAN FACTION ===
    "Allfather": {
        "basicAttack": "Rune Edge — The Allfather swings his rune-carved blade in a heavy 3-hit combo. The first two hits are wide cleaves; the third plants a rune on the ground that explodes after 1 second, damaging enemies standing on it.",
        ...
        "signature": {"name": "Storm Sovereignty", "type": "Zone Control", "cd": 18, "divineCost": 70, "effect": "Channel the power of the Aesir throne — create a storm circle around himself. Inside the circle, the Allfather gains super armor, enemies are struck by lightning every second, and his attacks gain thunder damage. Lasts 6 seconds."},
        "ultimate": {"name": "Allfather Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Open the rune-sealed eye for 8 seconds: time slows for all enemies while the Allfather moves at normal speed. Every attack during this state leaves a rune-mark that detonates when the ascension ends, dealing accumulated damage."},
        "passive": {"name": "Oath-Bound", "effect": "The Allfather gains Oath Fury every time he blocks or takes damage. At 5 stacks, his next attack gains thunder damage and knocks back all enemies hit."},
    },
    "Hrothar": {
        "basicAttack": "Fate Reaver — Hrothar swings in a medium-speed 3-hit combo. Each hit harvests a small amount of battle-fate energy from enemies. Third hit releases the harvested energy as a shockwave.",
        ...
        "ability2": {"name": "Fate Harvest", "type": "Burst", "cd": 10, "divineCost": 40, "effect": "Detonate all fate marks on screen. Each mark explodes for damage based on how much damage the marked enemy has dealt since being marked. Hrothar heals for 10% of total damage dealt."},
        "signature": {"name": "Battle-Fate Storm", "type": "Empower", "cd": 18, "divineCost": 70, "effect": "Enter Valkyrie Frenzy for 6 seconds: attack speed doubled, every third attack releases a fate-marked shockwave, and Hrothar is immune to crowd control."},
        "ultimate": {"name": "Chooser Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Hrothar chooses the slain — all enemies below 50% HP are marked for death. For 8 seconds, Hrothar gains massive speed and damage against marked targets. Killing a marked target during ascension refunds 2 seconds of duration."},
        "passive": {"name": "Fate Weighing", "effect": "Hrothar gains Oath Fury every time an enemy near him dies. At 5 stacks, his next attack heals him and releases a fate shockwave."},
    },
    "Skeld": {
        "basicAttack": "Root Strike — Skeld attacks with root-iron claws in a 3-hit combo. Each hit extends root tendrils into the ground, creating a small root patch that slows enemies who step on it. Third hit causes all root patches to constrict, damaging and rooting enemies.",
        ...
        "signature": {"name": "Nine-World Crossing", "type": "Field Control", "cd": 20, "divineCost": 75, "effect": "Open root-gates to all nine worlds — the entire battlefield becomes root-infested terrain for 6 seconds. All enemies are slowed, all root patches deal damage, and Skeld gains massive regeneration while standing on roots."},
        "ultimate": {"name": "Yggdrasil Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Skeld becomes the World Tree for 8 seconds: he roots into the ground, becoming immobile but gaining a massive health pool. While rooted, he can fire root-tendrils in all directions, each one dealing heavy damage and pulling enemies toward him."},
        "passive": {"name": "Root-Sight", "effect": "Skeld gains Oath Fury every time an enemy is rooted or slowed by his terrain. At 5 stacks, his next root patch explodes instead of slowing."},
    },
    "Eirwyn": {
        "basicAttack": "Shatter Combo — Eirwyn swings her war-judge maul in a heavy 2-hit combo. First hit shatters enemy armor (reduces defense). Second hit deals bonus damage based on how much armor was shattered.",
        "ability1": {"name": "Feast Call", "type": "Buff", "cd": 8, "divineCost": 30, "effect": "Ring the feast-horn — all nearby allies gain 20% damage boost and 10% damage reduction for 5 seconds. Eirwyn gains double the bonus."},
        ...
        "signature": {"name": "Valhalla's Test", "type": "Zone", "cd": 18, "divineCost": 70, "effect": "Create a trial arena around herself. Inside the arena, all healing is disabled for enemies, all buffs are suppressed, and Eirwyn gains super armor. Lasts 6 seconds. Enemies who flee the arena take damage."},
        "ultimate": {"name": "Death-Feast Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Eirwyn becomes the Chooser of the Slain for 8 seconds: her maul grows to colossal size, every hit is guaranteed critical, and every kill during ascension heals her for 25% of her max HP. She leaves a trail of honored-dead energy that empowers allies."},
        "passive": {"name": "Breaker of False Sanctuary", "effect": "Eirwyn gains Oath Fury every time she strips a buff or shatters armor. At 5 stacks, her next attack is unblockable and deals 2x damage to buffed enemies."},
    },
    
    # === OLYMPIAN FACTION ===
    "Aurelion": {
        "basicAttack": "Thunder Cleave — Aurelion swings his thunder-charged spear in a 3-hit combo. Each hit releases a bolt of lightning that chains to nearby enemies. Third hit plants the spear, creating a thunder zone that damages enemies inside.",
        ...
        "signature": {"name": "Sky Throne", "type": "Zone Control", "cd": 18, "divineCost": 70, "effect": "Summon the throne of Olympus — create a sacred platform that elevates Aurelion above the battlefield. From the throne, his range and damage are increased, and he rains thunder on all enemies below. Lasts 6 seconds."},
        "ultimate": {"name": "Thunder King Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Aurelion becomes the Thunder Verdict for 8 seconds: every attack calls down a thunderbolt on the target, his basic attacks become ranged lightning blasts, and all enemies near him are continuously struck by chain lightning."},
        "passive": {"name": "Glory Accumulated", "effect": "Aurelion gains Divine Glory every time his abilities hit enemies. At 5 stacks, his next basic attack releases a thunder chain that hits all enemies in range."},
    },
    "Kallix": {
        "basicAttack": "Marble Storm — Kallix fires rapid marble-energy projectiles in a 3-shot burst. Each projectile pierces one enemy. Third shot is a charged blast that explodes on impact, damaging all nearby enemies.",
        ...
        "ability2": {"name": "Ambrosia Burst", "type": "Heal/Damage", "cd": 10, "divineCost": 40, "effect": "Release a burst of ambrosial energy that heals Kallix for 15% max HP and damages all nearby enemies. Enemies hit are marked with glory, taking bonus damage from all sources for 3 seconds."},
        ...
        "ultimate": {"name": "Ambrosia Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Kallix becomes the Ambrosia Font for 8 seconds: he continuously emits healing energy that restores nearby allies, his attacks become homing marble-storm blasts, and he gains immunity to crowd control. All kills during ascension extend the duration by 1 second."},
        "passive": {"name": "Glory Engine", "effect": "Kallix generates Divine Glory faster than other deities — every 3rd basic attack refunds 10 Divine Glory. At max Divine Glory, his next ability is free."},
    },
    "Thyressa": {
        "basicAttack": "Aegis Wave — Thyressa fires golden aegis shields that bounce between enemies. Each bounce reduces enemy movement speed. Third hit creates a large shield that damages and pushes back all enemies in front.",
        ...
        "ultimate": {"name": "Golden Aegis Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Thyressa becomes the Golden Aegis for 8 seconds: her body radiates golden shield energy. All nearby allies gain continuous shields. She gains super armor and reflects all projectiles. Her attacks become wide golden waves that push enemies back."},
        "passive": {"name": "Aegis Mastery", "effect": "Thyressa gains Divine Glory every time she blocks or reflects damage. At 5 stacks, her next shield ability covers a 50% larger area."},
    },
    "Ilyon": {
        "basicAttack": "Moon Hunt — Ilyon fires moon-tipped arrows in a rapid 3-shot sequence. Each arrow pierces and leaves a moon-mark on the target. Third shot is a charged arrow that detonates all moon-marks for bonus damage.",
        ...
        "ability2": {"name": "Hunter's Mark", "type": "Debuff/Buff", "cd": 8, "divineCost": 35, "effect": "Mark the nearest enemy as prey. For 5 seconds, Ilyon's attacks against the marked target have 100% crit chance and deal 50% bonus damage. The mark transfers on kill."},
        ...
        "ultimate": {"name": "Artemis Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Ilyon becomes the Moon Huntress for 8 seconds: her arrows become piercing moon-beams that pass through all enemies, her attack speed is tripled, and every shot applies a moon-mark that detonates immediately. She gains 100% dodge chance during ascension."},
        "passive": {"name": "Huntress Focus", "effect": "Ilyon gains Divine Glory for every moon-mark detonation. At 5 stacks, her next charged arrow is a guaranteed critical hit that creates a moon-explosion on impact."},
    },
    
    # === KAMI FACTION ===
    "Amaterion": {
        "basicAttack": "Sun Mirror — Amaterion fires concentrated sunlight from his mirror in a 3-hit beam combo. Each beam is narrow but pierces all enemies in a line. Third hit widens the beam to a cone, damaging all enemies in front.",
        ...
        "ultimate": {"name": "Amaterasu Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Amaterion becomes the Sun Mirror for 8 seconds: his body radiates blinding sunlight in all directions. All enemies in range are continuously burned, all ally abilities are empowered, and Amaterion's basic attacks become massive solar beams that sweep across the battlefield."},
        "passive": {"name": "Sacred Authority", "effect": "Amaterion gains Kami Energy every time an enemy is inside one of his zones. At 5 stacks, his next beam attack is 3x wider and deals 2x damage."},
    },
    "Tsukiro": {
        "basicAttack": "Moon Order — Tsukiro strikes with moon-charged blades in a fast 4-hit combo. Each hit applies a moon-shadow debuff. Fourth hit detonates all moon-shadows, dealing bonus damage and healing Tsukiro.",
        ...
        "signature": {"name": "Moonlit Domain", "type": "Field Control", "cd": 16, "divineCost": 65, "effect": "Create a domain of moonlight over a large area. Inside the domain, enemies are slowed and their cooldowns are extended. Tsukiro gains invisibility when not attacking and his attacks deal bonus moon damage."},
        "ultimate": {"name": "Tsukuyomi Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Tsukiro becomes the Moon Order Lord for 8 seconds: he gains massive speed, every attack applies 3 moon-shadows, all moon-shadows detonate automatically, and he can teleport to any moon-shadow on the battlefield."},
        "passive": {"name": "Moon Cycle", "effect": "Tsukiro gains Kami Energy every time a moon-shadow detonates. At 5 stacks, his next dash creates 3 moon-shadow trails instead of 1."},
    },
    "Raidenko": {
        "basicAttack": "Storm Script — Raidenko fires lightning-charged talismans in a 3-shot burst. Each talisman sticks to an enemy and pulses storm damage. Third shot fires a chain lightning bolt between all stuck talismans.",
        ...
        "ultimate": {"name": "Storm Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Raidenko becomes the Storm itself for 8 seconds: his body crackles with lightning, every movement leaves a storm trail, his basic attacks become thunder-chains that hit all enemies in range, and he gains 100% dodge chance."},
        "passive": {"name": "Storm Charge", "effect": "Raidenko gains Kami Energy every time his lightning chains to multiple enemies. At 5 stacks, his next thunder call hits twice."},
    },
    "Mizuka": {
        "basicAttack": "Shrine Tide — Mizuka attacks with water-charged shrine weapons in a 3-hit combo. Each hit creates a water ripple that damages enemies in a small area. Third hit releases a wave that pushes enemies back.",
        "ability1": {"name": "Mirror Lake", "type": "Zone/Counter", "cd": 7, "divineCost": 30, "effect": "Create a mirror-lake zone on the ground. Enemies inside are slowed and their projectiles are reflected back. Mizuka gains invisibility when standing inside the lake."},
        ...
        "signature": {"name": "Sacred Tide", "type": "Field Control", "cd": 18, "divineCost": 70, "effect": "Summon a shrine-tide that floods a large area. Enemies in the flood are pushed toward the center, take continuous damage, and cannot use dash abilities. Mizuka gains increased attack speed while inside the flood."},
        "ultimate": {"name": "Mirror Lake Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Mizuka becomes the Mirror Lake for 8 seconds: the entire battlefield floods with sacred water. All enemies are slowed by 50%, all projectiles are reflected, and Mizuka can teleport to any point in the flood. Her attacks become massive water blasts."},
        "passive": {"name": "Tide Keeper", "effect": "Mizuka gains Kami Energy every time she reflects a projectile or knocks back an enemy. At 5 stacks, her next water attack creates a wave that hits all enemies on screen."},
    },
    
    # === TUATHA FACTION ===
    "Dagoran": {
        "basicAttack": "Root Crown — Dagoran swings his cauldron-club in a heavy 3-hit combo. Each hit creates a small root growth on the ground. Third hit causes all root growths to erupt, damaging and rooting enemies standing on them.",
        ...
        "ultimate": {"name": "Dagda Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Dagoran becomes the Good God for 8 seconds: the entire battlefield becomes a sacred grove. All allies are continuously healed, all enemies are continuously damaged by roots, and Dagoran's club grows to colossal size, each swing covering a massive area."},
        "passive": {"name": "Living World", "effect": "Dagoran gains Wild Growth every time a root growth erupts. At 5 stacks, his next attack plants a grove that auto-erupts."},
    },
    "Eryndor": {
        "basicAttack": "Oak Pulse — Eryndor fires living-oak energy in a 3-hit combo. Each hit stores a small amount of life energy. Third hit releases stored energy as a burst that heals Eryndor and damages nearby enemies.",
        ...
        "ability2": {"name": "Life Harvest", "type": "Heal/Damage", "cd": 10, "divineCost": 40, "effect": "Drain life from all nearby enemies, healing Eryndor for 100% of damage dealt. Enemies hit are weakened, dealing 30% less damage for 3 seconds."},
        ...
        "ultimate": {"name": "Wild Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Eryndor becomes the Living Oak for 8 seconds: he transforms into a massive tree-form, gaining 200% HP and becoming immobile. While in tree form, he continuously heals allies, fires homing thorn-volleys at all enemies, and all terrain near him becomes entangling roots."},
        "passive": {"name": "Adaptive Endurance", "effect": "Eryndor gains Wild Growth every time he heals or is healed. At 5 stacks, his next life harvest hits all enemies on screen."},
    },
    "Melian": {
        "basicAttack": "Thorn Song — Melian fires thorn-vine projectiles in a 3-shot burst. Each projectile applies a thorn-stack. At 3 stacks, the enemy is rooted and takes continuous nature damage for 2 seconds.",
        ...
        "signature": {"name": "Wild Domain", "type": "Field Control", "cd": 18, "divineCost": 70, "effect": "Transform a large area into a fae wild. Inside the wild, enemies are continuously damaged by thorns, their movement is erratic (random direction changes), and Melian gains fae-glass shields that regenerate. Lasts 6 seconds."},
        "ultimate": {"name": "Fae Queen Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Melian becomes the Fae Queen for 8 seconds: her body radiates fae energy. Every attack automatically applies max thorn-stacks. All enemies near her are continuously blinded and rooted. She can teleport between any fae-wild zones on the battlefield."},
        "passive": {"name": "Thorn Accumulation", "effect": "Melian gains Wild Growth every time a thorn-stack triggers. At 5 stacks, her next projectile volley applies 3 stacks to each enemy hit."},
    },
    "Bran": {
    ...
    # === EMPYREAN FACTION ===
    "Seraphel": {
        "basicAttack": "Holy Edge — Seraphel swings a white-gold blade in a 3-hit combo. Each hit releases a holy spark that damages nearby enemies. Third hit creates a holy flash that blinds all enemies in a cone for 1 second.",
        "ability1": {"name": "Holy Bastion", "type": "Shield/Zone", "cd": 8, "divineCost": 30, "effect": "Create a holy barrier around Seraphel that blocks all projectiles and damages enemies who touch it. Allies inside gain 30% damage reduction. Lasts 4 seconds."},
        ...
        "signature": {"name": "Seraph Throne", "type": "Zone Control", "cd": 18, "divineCost": 70, "effect": "Summon a radiant throne that creates a holy domain. Inside the domain, Seraphel gains super armor, his attacks become ranged holy beams, and all enemies take continuous holy damage. Lasts 6 seconds."},
        "ultimate": {"name": "Seraph Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Seraphel becomes the Seraph for 8 seconds: six wings of holy fire manifest, all attacks become sweeping holy beams, he gains 100% flight speed, and the entire battlefield is bathed in holy light that damages enemies and heals allies."},
        "passive": {"name": "Holy Authority", "effect": "Seraphel gains Holy Light every time he blocks or smites. At 5 stacks, his next holy flash becomes a screen-wide blind that damages all enemies."},
    },
    "Caelion": {
        "basicAttack": "Opal Bolt — Caelion fires opal-glass projectiles in a rapid 3-shot burst. Each projectile pierces and applies a holy-mark. Third shot detonates all holy-marks for bonus damage.",
        ...
        "signature": {"name": "Hierarch's Decree", "type": "Zone/Empower", "cd": 18, "divineCost": 70, "effect": "Create a radiant hierarchy zone. Inside the zone, Caelion gains +50% damage and his basic attacks become holy lances. Enemies inside are branded and take continuous holy damage. Lasts 6 seconds."},
        "ultimate": {"name": "Holy Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Caelion becomes the Radiant Hierarch for 8 seconds: his body becomes pure holy light, his attacks become infinite-range holy beams that pierce everything, and he gains 100% dodge. All holy-marks on screen detonate continuously."},
        "passive": {"name": "Light Engine", "effect": "Caelion gains Holy Light faster than other deities — every 3rd basic attack refunds 10 Holy Light. At max Holy Light, his next ability is free and deals 2x damage."},
    },
    "Aurelia": {
        "basicAttack": "Pearl Wave — Aurelia fires pearl-energy waves in a 3-hit combo. Each wave is wide but short-range. Third hit creates a large wave that pushes enemies back and applies a pearl-mark.",
        ...
        "ultimate": {"name": "Order Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Aurelia becomes the Divine Order for 8 seconds: all enemy movement is slowed to 30%, all enemy abilities are locked, and her pearl waves become massive screen-clearing tsunamis. She gains super armor and reflects all damage."},
        "passive": {"name": "Mirror Mastery", "effect": "Aurelia gains Holy Light every time she reflects or roots an enemy. At 5 stacks, her next pearl wave covers the entire screen."},
    },
    "Malachor": {
        "basicAttack": "Black Silence — Malachor swings a black-iron blade in a 3-hit combo. Each hit applies a silence-stack. At 3 stacks, the enemy is silenced for 2 seconds and takes bonus holy damage.",
        "ability1": {"name": "Silent Strike", "type": "Debuff/Burst", "cd": 6, "divineCost": 30, "effect": "Dash through an enemy, applying 3 silence-stacks instantly. The enemy is silenced and Malachor's next attack against them is a guaranteed critical."},
        "ability2": {"name": "Black Chains", "type": "Crowd Control", "cd": 9, "divineCost": 40, "effect": "Summon black-iron chains that grab all enemies in a large area, pulling them toward Malachor. Pulled enemies are stunned for 1 second and take bonus damage."},
        "signature": {"name": "Judgment Lock", "type": "Zone/Execute", "cd": 18, "divineCost": 70, "effect": "Create a zone of black silence. All enemies inside are silenced, their abilities are locked, and they take continuous holy damage. Enemies below 30% HP inside the zone are marked for execution — Malachor's attacks against them deal 5x damage. Lasts 5 seconds."},
        "ultimate": {"name": "Black Silence Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Malachor becomes the Black Silence for 8 seconds: all enemies on screen are silenced, all enemy abilities are locked, Malachor's attacks become teleporting execution strikes that appear behind each enemy, and every kill refunds 2 seconds of duration."},
        "passive": {"name": "Silence Accumulation", "effect": "Malachor gains Holy Light every time a silence-stack triggers. At 5 stacks, his next attack silences all enemies in range for 3 seconds."},
    },
    
    # === INFERNAL DOMINION FACTION ===
    "Mordrath": {
        "basicAttack": "Black Iron Cleave — Mordrath swings a massive black-iron blade in a 3-hit combo. First two hits are wide cleaves. Third hit is a ground-slam that creates a fissure, damaging enemies in a line and applying burn.",
        "ability1": {"name": "Iron Bastion", "type": "Shield/Zone", "cd": 8, "divineCost": 30, "effect": "Raise black-iron walls on both sides, creating a fortified corridor. Enemies inside the corridor take continuous fire damage. Mordrath gains 50% damage reduction while inside. Lasts 4 seconds."},
        ...
        "signature": {"name": "Black Iron Dominion", "type": "Zone Control", "cd": 18, "divineCost": 70, "effect": "Transform the ground into black-iron court. All enemies inside are slowed by 50%, take continuous fire damage, and their defense is reduced. Mordrath gains super armor and his attacks deal bonus fire damage. Lasts 6 seconds."},
        "ultimate": {"name": "Infernal Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Mordrath becomes the Black Iron Lord for 8 seconds: his body grows to massive size, his blade becomes a colossal execution axe, each swing creates a fissure that spans the screen, and all enemies near him are continuously chained and burned."},
        "passive": {"name": "Infernal Authority", "effect": "Mordrath gains Infernal Fury every time he chains or burns an enemy. At 5 stacks, his next ground-slam creates 3 fissures instead of 1."},
    },
    "Varkul": {
        "basicAttack": "Ash Strike — Varkul fires ash-charged projectiles in a 3-shot burst. Each projectile applies an ash-stack. At 5 ash-stacks, the enemy is stunned and takes a burst of infernal damage.",
        ...
        "ultimate": {"name": "Ash Lord Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Varkul becomes the Ash Lord for 8 seconds: his body becomes a walking inferno. Every attack automatically applies max ash-stacks. All ash-stacks on screen detonate continuously. He gains 100% attack speed and immunity to crowd control. Every kill extends duration by 1 second."},
        "passive": {"name": "Ash Accumulation", "effect": "Varkul gains Infernal Fury every time an ash-stack triggers. At 5 stacks, his next cinder storm covers the entire screen."},
    },
    "Nyxara": {
        "basicAttack": "Shadow Pulse — Nyxara fires obsidian-shadow projectiles in a 3-shot burst. Each projectile applies a shadow-mark. Third shot detonates all shadow-marks, dealing bonus damage and healing Nyxara.",
        ...
        "ability2": {"name": "Obsidian Field", "type": "Zone/Debuff", "cd": 9, "divineCost": 40, "effect": "Create a field of obsidian shadow. Enemies inside are slowed, their attacks have 50% miss chance, and they take continuous shadow damage. Nyxara gains invisibility within the field."},
        "signature": {"name": "Shadow Dominion", "type": "Field Control", "cd": 18, "divineCost": 70, "effect": "Expand obsidian shadow across a large area. All enemies inside are rooted, take continuous shadow damage, and their abilities are silenced. Nyxara can teleport to any point inside the dominion. Lasts 5 seconds."},
        "ultimate": {"name": "Shadow Queen Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Nyxara becomes the Shadow Queen for 8 seconds: she becomes pure shadow, untargetable by enemies. She can teleport to any shadow-mark on screen, every teleport deals massive burst damage, and all enemies near her are continuously drained of HP and healed into Nyxara."},
        "passive": {"name": "Shadow Accumulation", "effect": "Nyxara gains Infernal Fury every time a shadow-mark detonates. At 5 stacks, her next shadow step creates 3 shadow echoes that attack independently."},
    },
    "Azrakar": {
        "basicAttack": "Chain Break — Azrakar swings chain-wrapped blades in a fast 4-hit combo. Each hit applies a chain-stack. Fourth hit yanks all chained enemies toward Azrakar and deals bonus damage.",
        "ability1": {"name": "Chain Grasp", "type": "Mobility/CC", "cd": 5, "divineCost": 25, "effect": "Throw chains at a target, pulling Azrakar to them (if large enemy) or pulling them to Azrakar (if small enemy). The chained target is stunned for 1 second and takes bonus damage."},
        "ability2": {"name": "Chain Storm", "type": "Burst/AoE", "cd": 10, "divineCost": 40, "effect": "Spin with chains extended, creating a massive whirlwind that damages all enemies in range and applies chain-stacks. All chained enemies are pulled toward Azrakar when the storm ends."},
        "signature": {"name": "Execution Verdict", "type": "Burst/Execute", "cd": 18, "divineCost": 70, "effect": "Mark all chained enemies for execution. Azrakar unleashes a chain-storm that hits each marked enemy with a devastating strike. Damage scales with chain-stacks on each enemy. Enemies below 30% HP are instantly executed."},
        "ultimate": {"name": "Chain Lord Ascension", "type": "Ascension", "cd": 0, "ascensionCost": 100, "effect": "Azrakar becomes the Chain Lord for 8 seconds: chains extend from his body in all directions, automatically grabbing all enemies on screen. He can teleport to any chained enemy, each teleport dealing massive burst damage. All chained enemies are continuously pulled toward him and take damage."},
        "passive": {"name": "Chain Accumulation", "effect": "Azrakar gains Infernal Fury every time a chain-stack triggers. At 5 stacks, his next chain grasp hits all enemies in range."},
    },
}
